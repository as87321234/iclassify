...
@Entity
@Table(name = "ex_blast_report")
@NamedQuery(name = "ExBlastReport.findAll", query = "SELECT e FROM ExBlastReport e")
@ToString
public class ExBlastReport extends ExEntity implements Serializable {
