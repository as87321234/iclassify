...
@NamedStoredProcedureQuery(name = "materializeViewExEventdataFact", procedureName = "materializeviewexeventdatafact")
@Entity
@Table(name = "ex_event_data_fact")
@NamedQuery(name = "ExEventDataFact.findAll", query = "SELECT e FROM ExEventDataFact e")
@ToString
public class ExEventDataFact extends ExEntity implements Serializable {
    ...
    @Type(type = "jsonb")
    @Column(name = "report_list", columnDefinition = "jsonb")
    private List<String> reportList;

    @Column(name = "report_cnt")
    private BigDecimal reportCnt;

    public ExEventDataFact() {
    }
    ...
    public BigDecimal getReportCnt() {
	return reportCnt;
    }

    public void setReportCnt(BigDecimal reportCnt) {
