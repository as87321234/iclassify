...
@Entity
@Cacheable(false)
public class ViewXBlastReport extends ExEntity implements Serializable {
	...
	@Column(name = "detonation_method_desc")
	...
	@Column(name = "firing_location_desc")
	...
	@Column(name = "mining_method_desc")
	...
	@Column(name = "stemming_material_desc")
	...
	@Column(name = "wind_direction_desc")
	...
	@Column(name = "wind_velocity_desc")
	private String windVelocityDesc;
	...
	public String getWindVelocityDesc() {
		return windVelocityDesc;
	}

	public void setWindVelocityDesc(final String windVelocityDesc) {
		this.windVelocityDesc = windVelocityDesc;
	}
	...
	public UUID getCreatedByUserId() {
		return super.getCreatedByUserId();
	}
	...
	public String getLastModifiedByUser() {
		return super.getLastModifiedByUser();
	}

	@Override
	public UUID getLastModifiedByUserId() {
		return super.getLastModifiedByUserId();
	}
